...
echo 8. Ver la ruta de los paquetes (tracert)
echo 9. Consultar la traduccion de los nombres a las direcciones IP (nslookup)
echo.
set /p op=Opcion: 
...
if "%op%"=="8" set /p x=Ingrese la direccion & tracert %x%
if "%op%"=="9" set /p x=Ingrese la direccion a traducir & nslookup %x%
